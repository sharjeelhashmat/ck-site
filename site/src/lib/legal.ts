...
export const PRIVACY: LegalSection[] = [
  {
    ...
    p: [
      `This policy applies to sharjeelhashmat.com and describes how ${SITE.name} ("I", "me"), as the data controller, collects, uses and stores personal data from visitors, enquirers and clients in connection with UAE real estate services. This site is operated as a personal brand and is not affiliated with any employer; a RERA registration reference is separately shown in the site's footer and About page for regulatory purposes.`,
    ],
  },
  {
    h: '2. What I collect',
...
export const TERMS: LegalSection[] = [
  ...
  { h: '10. Intellectual property', p: [`The Compass Key name, mark, and "Sharjeel Property Brief™" are the property of ${SITE.name} and may not be reproduced or used without permission. Site content may not be copied or republished without consent.`] },
